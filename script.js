...
// Crear corazones de fondo continuamente
function startBackgroundHearts() {
    ...
    backgroundHeartsInterval = setInterval(() => {
        createFloatingHeart();
    }, 1500);
}

// Crear explosión de corazones al hacer clic en una carta
function createHeartBurst(x, y) {
    ...
    for (let i = 0; i < burstCount; i++) {
        ...
        // Calcular dirección de dispersión en círculo
...
function openEnvelope() {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            showPapers();
            // Iniciar corazones de fondo cuando aparecen las cartas
